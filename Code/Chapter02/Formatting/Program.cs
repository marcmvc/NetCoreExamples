...
namespace Formatting
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            WriteLine(format:"{0,-8} {1,7:N0}",arg0:"Name", arg1:"Count");
            WriteLine(format:"{0,-8} {1,7:N0}",arg0:applesText,arg1:applesCount);
            WriteLine(format:"{0,-8} {1,7:N0}",arg0:bananasText,arg1:bananasCount);
